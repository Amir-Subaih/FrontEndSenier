    ...
    return (
        <div className="container mb-5" dir="rtl">
            <div className={`row ${style.container}`}>
                <p className={`${style.contact}`}>اتصل بنا</p>
                ...
                <div className="col-md-6">
                    <form onSubmit={handelSubmit}>
                        <div className="name">
                            <input type="text" name="name" className="form-control" value={users.name} onChange={ChangeData} id="exampleFormControlInput1" placeholder="الاسم:" />
                            {errors.name && <p className='text-danger'>{errors.name}</p>}
                        </div>
                        <div className="email mt-3">
                            <input type="email" name="email" className="form-control" value={users.email} onChange={ChangeData}  id="exampleFormControlInput1" placeholder="البريد الإلكتروني:" />
